...
10.times do |blog|
	Blog.create!(
		...
		body: "ed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, 
...
User.create(email: "asdfasdf@asdf.com",
			password: "asdfasdf",
			password_confirmation: "asdfasdf",
			name: "Regular User",
			)
